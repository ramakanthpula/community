    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.visitors.update", [$visitor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Visitor::CHECK_IN_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('check_in_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="check_in_type_{{ $key }}" name="check_in_type" value="{{ $key }}" {{ old('check_in_type', $visitor->check_in_type) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $visitor->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                    ...
                    @foreach(App\Models\Visitor::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $visitor->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" required>{{ old('address', $visitor->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company') ? 'is-invalid' : '' }}" type="text" name="company" id="company" value="{{ old('company', $visitor->company) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('unit_no') ? 'is-invalid' : '' }}" name="unit_no_id" id="unit_no_id" required>
                    @foreach($unit_nos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('unit_no_id') ? old('unit_no_id') : $visitor->unit_no->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo') ? 'is-invalid' : '' }}" type="text" name="photo" id="photo" value="{{ old('photo', $visitor->photo) }}">
                @if($errors->has('photo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('photo') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('in_time') ? 'is-invalid' : '' }}" type="text" name="in_time" id="in_time" value="{{ old('in_time', $visitor->in_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('out_time') ? 'is-invalid' : '' }}" type="text" name="out_time" id="out_time" value="{{ old('out_time', $visitor->out_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whom_to_meet') ? 'is-invalid' : '' }}" type="text" name="whom_to_meet" id="whom_to_meet" value="{{ old('whom_to_meet', $visitor->whom_to_meet) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purpose_of_visit') ? 'is-invalid' : '' }}" type="text" name="purpose_of_visit" id="purpose_of_visit" value="{{ old('purpose_of_visit', $visitor->purpose_of_visit) }}">
