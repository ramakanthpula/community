...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.defect.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.defects.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('defect_type') ? 'is-invalid' : '' }}" name="defect_type_id" id="defect_type_id" required>
                    @foreach($defect_types as $id => $defect_type)
                        <option value="{{ $id }}" {{ old('defect_type_id') == $id ? 'selected' : '' }}>{{ $defect_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('defect_sub_type') ? 'is-invalid' : '' }}" name="defect_sub_type_id" id="defect_sub_type_id" required>
                    @foreach($defect_sub_types as $id => $defect_sub_type)
                        <option value="{{ $id }}" {{ old('defect_sub_type_id') == $id ? 'selected' : '' }}>{{ $defect_sub_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('incident_location') ? 'is-invalid' : '' }}" type="text" name="incident_location" id="incident_location" value="{{ old('incident_location', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('defect_details') ? 'is-invalid' : '' }}" type="text" name="defect_details" id="defect_details" value="{{ old('defect_details', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('problem_description') ? 'is-invalid' : '' }}" name="problem_description" id="problem_description" required>{{ old('problem_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('convenient_time') ? 'is-invalid' : '' }}" type="text" name="convenient_time" id="convenient_time" value="{{ old('convenient_time') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('desired_outcome') ? 'is-invalid' : '' }}" name="desired_outcome" id="desired_outcome" required>{{ old('desired_outcome') }}</textarea>
