    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blocks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('block_name') ? 'is-invalid' : '' }}" type="text" name="block_name" id="block_name" value="{{ old('block_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('block_admin_contact') ? 'is-invalid' : '' }}" type="text" name="block_admin_contact" id="block_admin_contact" value="{{ old('block_admin_contact', '') }}" required>
