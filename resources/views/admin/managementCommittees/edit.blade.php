...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.managementCommittee.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.management-committees.update", [$managementCommittee->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="member_name">{{ trans('cruds.managementCommittee.fields.member_name') }}</label>
                <input class="form-control {{ $errors->has('member_name') ? 'is-invalid' : '' }}" type="text" name="member_name" id="member_name" value="{{ old('member_name', $managementCommittee->member_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $managementCommittee->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $managementCommittee->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('present_address') ? 'is-invalid' : '' }}" name="present_address" id="present_address">{{ old('present_address', $managementCommittee->present_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" name="permanent_address" id="permanent_address" required>{{ old('permanent_address', $managementCommittee->permanent_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhaar') ? 'is-invalid' : '' }}" type="text" name="aadhaar" id="aadhaar" value="{{ old('aadhaar', $managementCommittee->aadhaar) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('designation') ? 'is-invalid' : '' }}" name="designation_id" id="designation_id" required>
                    @foreach($designations as $id => $designation)
                        <option value="{{ $id }}" {{ (old('designation_id') ? old('designation_id') : $managementCommittee->designation->id ?? '') == $id ? 'selected' : '' }}>{{ $designation }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $managementCommittee->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $managementCommittee->end_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('member_status') ? 'is-invalid' : '' }}" name="member_status" id="member_status">
                    ...
                    @foreach(App\Models\ManagementCommittee::MEMBER_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('member_status', $managementCommittee->member_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
