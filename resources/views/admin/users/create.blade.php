    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternate_contact') ? 'is-invalid' : '' }}" type="text" name="alternate_contact" id="alternate_contact" value="{{ old('alternate_contact', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('present_address') ? 'is-invalid' : '' }}" type="text" name="present_address" id="present_address" value="{{ old('present_address', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="text" name="nid" id="nid" value="{{ old('nid', '') }}" required>
                @if($errors->has('nid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('block_name') ? 'is-invalid' : '' }}" name="block_name_id" id="block_name_id" required>
                    @foreach($block_names as $id => $entry)
                        <option value="{{ $id }}" {{ old('block_name_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('floor_name') ? 'is-invalid' : '' }}" name="floor_name_id" id="floor_name_id" required>
                    @foreach($floor_names as $id => $entry)
                        <option value="{{ $id }}" {{ old('floor_name_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('units') ? 'is-invalid' : '' }}" name="units_id" id="units_id" required>
                    @foreach($units as $id => $entry)
                        <option value="{{ $id }}" {{ old('units_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('units'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tenancy_status') ? 'is-invalid' : '' }}" name="tenancy_status" id="tenancy_status">
                    ...
                    @foreach(App\Models\User::TENANCY_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tenancy_status', 'InActive') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
