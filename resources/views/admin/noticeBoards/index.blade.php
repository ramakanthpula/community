                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\NoticeBoard::PUBLISH_RADIO as $key => $item)
                        ...
                        <tr data-entry-id="{{ $noticeBoard->id }}">
                            ...
                            <td>
                                @can('notice_board_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.notice-boards.show', $noticeBoard->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('notice_board_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.notice-boards.edit', $noticeBoard->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('notice_board_delete')
                                    <form action="{{ route('admin.notice-boards.destroy', $noticeBoard->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
