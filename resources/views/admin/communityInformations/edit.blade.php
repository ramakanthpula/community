...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.communityInformation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.community-informations.update", [$communityInformation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.communityInformation.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $communityInformation->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $communityInformation->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('security_office_mobile_no') ? 'is-invalid' : '' }}" type="text" name="security_office_mobile_no" id="security_office_mobile_no" value="{{ old('security_office_mobile_no', $communityInformation->security_office_mobile_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secretary_mobile_no') ? 'is-invalid' : '' }}" type="text" name="secretary_mobile_no" id="secretary_mobile_no" value="{{ old('secretary_mobile_no', $communityInformation->secretary_mobile_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moderator_mobile_no') ? 'is-invalid' : '' }}" type="text" name="moderator_mobile_no" id="moderator_mobile_no" value="{{ old('moderator_mobile_no', $communityInformation->moderator_mobile_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('construction_year') ? 'is-invalid' : '' }}" type="text" name="construction_year" id="construction_year" value="{{ old('construction_year', $communityInformation->construction_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $communityInformation->address) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\CommunityInformation::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $communityInformation->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
