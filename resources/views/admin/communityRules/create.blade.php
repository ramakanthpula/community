...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.communityRule.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.community-rules.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="apartment_policies">{{ trans('cruds.communityRule.fields.apartment_policies') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('apartment_policies') ? 'is-invalid' : '' }}" name="apartment_policies" id="apartment_policies">{!! old('apartment_policies') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('code_of_conduct') ? 'is-invalid' : '' }}" name="code_of_conduct" id="code_of_conduct">{!! old('code_of_conduct') !!}</textarea>
